...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/sr/4.0/SeaRegions.xsd, using strict XML schema validation.
