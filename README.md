...
The Data Specification on Sea Regions – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Sea Regions.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Sea Regions](http://inspire.ec.europa.eu/id/ats/data-sr/3.0/sr-gml) | INSPIRE spatial data set encoded in GML, Sea Regions features |
| [Application Schema, Sea Regions](http://inspire.ec.europa.eu/id/ats/data-sr/3.0/sr-as) | INSPIRE spatial data set |
| [Reference Systems, Sea Regions](http://inspire.ec.europa.eu/id/ats/data-sr/3.0/sr-rs) | INSPIRE spatial data set |
| [Data Consistency, Sea Regions](http://inspire.ec.europa.eu/id/ats/data-sr/3.0/sr-dc) | INSPIRE spatial data set |
| [Information Accessibility, Sea Regions](http://inspire.ec.europa.eu/id/ats/data-sr/3.0/sr-ia) | INSPIRE spatial data set |
| [Portrayal, Sea Regions](http://inspire.ec.europa.eu/id/ats/data-sr/3.0/sr-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Sea Regions - Core", are not needed as no feature instance can be of a type from that application schema.
