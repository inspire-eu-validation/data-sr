# Conformance class: Reference systems, Sea Regions
...
| ------------- | ----------------- | ---------------- | ---------- |
| [TG DS-SR](#ref_TG_DS_SR) | [GML application schema, Sea Regions](../sr-gml/README.md) | INSPIRE spatial data set encoded in GML, Sea Regions features | n/a |
